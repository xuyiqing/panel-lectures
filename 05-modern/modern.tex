...
\only<1-2| handout:0>{\includegraphics[height=0.4\textheight]{toy_hte_const.pdf}}%
\only<3-| handout:1>{\includegraphics[height=0.4\textheight]{toy_hte_const_box.pdf}}
\end{column}
\begin{column}{0.49\textwidth}\centering
\onslide<2->{{\footnotesize effects that grow ($B$) or fade ($C$)}\par
\only<2| handout:0>{\includegraphics[height=0.4\textheight]{toy_hte_dynamic.pdf}}%
\only<3-| handout:1>{\includegraphics[height=0.4\textheight]{toy_hte_dynamic_box.pdf}}}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.32\textwidth}
\centering
\onslide<2->{\includegraphics[width=\linewidth, height=0.27\textheight, keepaspectratio]{bischof_sa.png}
\par{\scriptsize Sun and Abraham}}
\end{column}
\begin{column}{0.32\textwidth}
\centering
\onslide<2->{\includegraphics[width=\linewidth, height=0.27\textheight, keepaspectratio]{bischof_stack.png}
...
\begin{column}{0.32\textwidth}
\centering
\onslide<3->{\includegraphics[width=\linewidth, height=0.27\textheight, keepaspectratio]{bischof_cs1.png}
\par{\scriptsize CSDID (not-yet-treated)}}
\end{column}
\begin{column}{0.32\textwidth}
\centering
\onslide<3->{\includegraphics[width=\linewidth, height=0.27\textheight, keepaspectratio]{bischof_cs2.png}
\par{\scriptsize CSDID (never-treated)}}
\end{column}
\begin{column}{0.32\textwidth}
\centering
\onslide<4->{\includegraphics[width=\linewidth, height=0.27\textheight, keepaspectratio]{bischof_fect.png}
...
\begin{column}{0.32\textwidth}
\centering
\onslide<2->{\includegraphics[width=\linewidth]{gs2020_placebo.pdf}
\par{\scriptsize placebo test}}
\end{column}
\begin{column}{0.32\textwidth}
\centering
\onslide<3->{\includegraphics[width=\linewidth]{gs2020_carryover.pdf}
...
\end{column}
\begin{column}{0.49\textwidth}\centering
\onslide<2->{\includegraphics[width=\linewidth, height=0.5\textheight, keepaspectratio]{ex2_lut_gap_short.pdf}}
\end{column}
\end{columns}
\end{frame}
...
\onslide<2->{\includegraphics[width=\linewidth, height=0.45\textheight, keepaspectratio]{ex3_compare_full.png}\par{\scriptsize replicated on the full sample}}
\end{column}
\begin{column}{0.4\textwidth}\centering
\onslide<3->{\includegraphics[width=\linewidth, height=0.45\textheight, keepaspectratio]{ex3_sub_twfe.png}\par{\scriptsize the paper's specification on its subsample}}
\end{column}
\end{columns}
\end{frame}
...
\onslide<2->{\includegraphics[width=\linewidth]{ex3_outcome_cohort.png}}
\end{column}
...
\end{itemize}
\onslide<3->{\begin{center}\includegraphics[height=0.36\textheight]{ex3_bacon_full.png}\end{center}}
\end{column}
\end{columns}
\end{frame}
...
\end{itemize}
\onslide<2->{\begin{center}\includegraphics[height=0.35\textheight]{ex3_bacon_sub.png}\end{center}}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.49\textwidth}
\centering
\onslide<2->{\includegraphics[width=0.92\linewidth, height=0.45\textheight, keepaspectratio]{caughey_honest.png}
...
\begin{column}{0.32\textwidth}
\centering
\onslide<2->{\includegraphics[width=\linewidth]{pvalues_fect.pdf}
\par{\scriptsize + relaxing constant effects (75\%)}}
\end{column}
\begin{column}{0.32\textwidth}
\centering
\onslide<3->{\includegraphics[width=\linewidth]{pvalues_robust.pdf}
...
\item Tutorial: \url{https://yiqingxu.org/packages/fect/}
\end{itemize}
\end{frame}
