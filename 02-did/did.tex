...
\frametitle{Signs of Parallel Trends Violations}
\centering\Large
\only<1>{\vspace{1em}\bf Gun Control on Crime\\\vspace{0.8em}\includegraphics[width=8cm]{ex_guncontrol.pdf}}%
\only<2>{\vspace{1em}\bf Democratization on Development\\\vspace{0.6em}\includegraphics[width=8cm]{ex_demoGDP.pdf}}%
\only<3>{\vspace{1em}\bf WTO on Trade\\\vspace{0.8em}\includegraphics[width=8cm]{ex_trade.pdf}}%
\only<4>{\vspace{1em}\bf Political Connections on Stock Returns\\\vspace{0.8em}\includegraphics[width=8cm]{ex_ajkkm.pdf}}%
\end{frame}
}
\fi
