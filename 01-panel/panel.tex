...
What would happen if a group of units experienced a set of counterfactual treatment histories?
\begin{center}
\only<1>{\includegraphics[height = 0.8\textheight]{seq0.pdf}}%
\only<2>{\includegraphics[height = 0.8\textheight]{seq2.pdf}}%
\only<3>{\includegraphics[height = 0.8\textheight]{seq1.pdf}}%
\end{center}
\end{frame}  
\fi
...
\input{figs/fatalities_results_2026.tex}
\end{center}
\bigskip
