...
\renewcommand*{\bibfont}{\fontsize{6pt}{7.2pt}\selectfont}   % one step below \scriptsize
\setlength{\bibitemsep}{0.7em}   % visible air between entries
\setlength{\bibhang}{0.5em}
% The References frame of every deck: \begin{frame}[t,allowframebreaks=1.1] ... \referencelist.
