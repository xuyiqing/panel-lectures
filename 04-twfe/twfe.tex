...
\fi
\if\handout0
\only<1>{\includegraphics[height=0.68\textheight, keepaspectratio=1]{sim_treat1.pdf}}%
\only<2>{\includegraphics[height=0.68\textheight, keepaspectratio=1]{sim_treat2.pdf}}%
\fi
\end{center}
\begin{itemize}
...
\begin{column}{0.49\textwidth}
\centering
\onslide<2->{\includegraphics[width=\linewidth]{ex_demoGDP.pdf}}
\end{column}
\end{columns}
\bigskip
\begin{itemize}
...
\begin{column}{0.49\textwidth}
\centering
\onslide<2->{\includegraphics[width=\linewidth]{ex_ajkkm.pdf}}
\end{column}
\end{columns}
\bigskip
\begin{itemize}
