...
\end{tikzpicture}}%
\only<4-5| handout:0>{\includegraphics[width=\linewidth, height=0.62\textheight, keepaspectratio]{raw.pdf}
\par{\scriptsize Raw data: mortality by level of social capital.}}%
\only<6-| handout:1>{\includegraphics[width=\linewidth, height=0.62\textheight, keepaspectratio]{fig5.pdf}
...
\begin{center}
\includegraphics[width=0.85\textwidth, height=0.66\textheight, keepaspectratio]{c_ex_fouka.pdf}
...
\begin{frame}
  \frametitle{More Examples}
\begin{center}
\includegraphics[width=0.85\textwidth, height=0.66\textheight, keepaspectratio]{c_ex_aer.pdf}
...
\centering
\includegraphics[width=\linewidth, height=0.5\textheight, keepaspectratio]{c_ex_ajps.pdf}
\par\smallskip{\small\onslide<2->{\alert{Elite strongholds $\times$ state-building reform}}}
\end{column}
\begin{column}{0.48\textwidth}
\centering
\includegraphics[width=\linewidth, height=0.5\textheight, keepaspectratio]{c_ex_jop.pdf}
...
\centering
\only<1| handout:0>{\includegraphics[width=\linewidth, height=0.6\textheight, keepaspectratio]{c_canonical_did.pdf}}%
\only<2-| handout:1>{\includegraphics[width=\linewidth, height=0.6\textheight, keepaspectratio]{c_factorial_did.pdf}}
\end{column}
\end{columns}
\end{frame}
...
\begin{center}
\begin{tikzpicture}
\node[anchor=south west, inner sep=0] (img) {\includegraphics[width=0.72\textwidth, height=0.58\textheight, keepaspectratio]{c_multiperiod.pdf}};
...
\only<1| handout:0>{%
\begin{tikzpicture}
\node[anchor=south west, inner sep=0] (m) at (0,0) {\includegraphics[width=\linewidth, height=0.7\textheight, keepaspectratio]{c_map_mortality.pdf}};
...
\only<2-| handout:1>{%
\begin{tikzpicture}
\node[anchor=south west, inner sep=0] (m) at (0,0) {\includegraphics[width=\linewidth, height=0.7\textheight, keepaspectratio]{c_map_genealogy.pdf}};
\begin{scope}
...
\node[anchor=south west, inner sep=0, overlay] at (-0.3pt,0) {\includegraphics[width=\linewidth, height=0.7\textheight, keepaspectratio]{c_map_mortality.pdf}};
\end{scope}
\fill[white, overlay] let \p1=(m.north west), \p2=(m.south east) in ({\x1-0.0100*(\x2-\x1)},{\y1+0.0000*(\y2-\y1)}) rectangle ({\x1+0.0117*(\x2-\x1)},{\y1+0.0320*(\y2-\y1)});
\end{tikzpicture}}
\end{column}
...
\centering
\onslide<2->{\includegraphics[width=\linewidth, height=0.72\textheight, keepaspectratio]{est_any.pdf}}
\end{column}
\end{columns}
\begin{itemize}
...
\item Tutorial: \url{https://yiqingxu.org/packages/fdid/}
\end{itemize}
\end{frame}
