...
\begin{columns}[T]
\column{.32\textwidth}
\apppanel{\includegraphics[width=\linewidth,height=1.5in,keepaspectratio,trim=2em 3em 2em 3em,clip]{ca2.pdf}}
  {Public policy}{California tobacco control}
\column{.32\textwidth}
\apppanel{\includegraphics[width=\linewidth,height=1.5in,keepaspectratio]{edr_raw3.pdf}}
  {Political economy}{Election-day registration}
\column{.32\textwidth}
\apppanel{\includegraphics[width=\linewidth,height=1.5in,keepaspectratio]{benin_data2.png}}
...
\vspace{1em}
\begin{center}
\only<1>{\includegraphics[width=0.70\textwidth]{scm_intuition1.pdf}}%
\only<2>{\includegraphics[width=0.70\textwidth]{scm_intuition2.pdf}}%
\only<3>{\includegraphics[width=0.70\textwidth]{scm_intuition3.pdf}}%
\only<4>{\includegraphics[width=0.70\textwidth]{scm_intuition4.pdf}}%
\only<5>{\includegraphics[width=0.70\textwidth]{scm_intuition5.pdf}}%
\only<6>{\includegraphics[width=0.70\textwidth]{scm_intuition6.pdf}}%
\end{center}
\end{frame}
}
\fi
...
\begin{frame}
\frametitle{DAG Compatible with Additive Fixed Effects}
\begin{center}
\includegraphics[width=0.62\textwidth, height=0.36\textheight, keepaspectratio]{dag_strict_exogeneity.png}
\end{center}\vspace{-0.3em}
\begin{itemize}[<+->]\itemsep0.25em
\item Two unobservables drive both $D_t$ and $Y_t$: a fixed unit trait $\alpha$ and period shocks $f_t$ (here, the time fixed effects)
\item $\alpha$ shifts a unit by the same amount in every period; $f_t$ shifts every unit by the same amount $\rightarrow$ \blue{parallel trends}; two-way demeaning removes both
\item No arrow from past outcomes to later treatment: treatment is set in advance (strict exogeneity)
\end{itemize}
\slidesource{\textcite{xu2023causal}, Figure 2. Gray: unobserved; dashed arrows: links involving unobservables.}
\end{frame}

\begin{frame}
\frametitle{What Synthetic Control Adds: The Same DAG, Augmented by Factors}
\begin{center}
\includegraphics[width=0.62\textwidth, height=0.36\textheight, keepaspectratio]{dag_factor_augmented.png}
\end{center}\vspace{-0.3em}
\begin{itemize}[<+->]\itemsep0.25em
\item Now the unobservable is $U_t = \lambda' f_t$: the same fixed trait $\lambda$, but its effect moves with common factors $f_t$
\item Units with different $\lambda$ respond differently to the same shocks $\rightarrow$ trends need not be parallel; DID fails here
\item $\lambda$ is fixed and $f_t$ is shared, so pre-treatment outcomes reveal them: \blue{match on them} (synthetic control) or \blue{estimate them} (factor models); TWFE is the special case $U_t = \alpha + f_t$
\item Still no feedback from past outcomes to treatment: the same regime as DID; only how $U_t$ enters differs
\end{itemize}
\slidesource{\textcite{xu2023causal}, Figure 7.}
\end{frame}
...
\end{itemize}
  \begin{center}
  \hspace{-2em}\includegraphics[height=2in,trim = 2em 3em 2em 3em, clip]{ca1.pdf}\\
...
\end{itemize}
  \begin{center}
  \hspace{-2em}\includegraphics[height=2in,trim = 2em 3em 2em 3em, clip]{ca2.pdf}\\
...
\column{.32\textwidth}
\apppanel{\includegraphics[width=\linewidth,height=1.5in,keepaspectratio]{ca3.pdf}}
  {1. The gap}{California minus synthetic California}
\column{.32\textwidth}
\apppanel{\includegraphics[width=\linewidth,height=1.5in,keepaspectratio]{ca4.pdf}}
  {2. Placebos}{Same gap computed for all 38 donor states}
\column{.32\textwidth}
\apppanel{\includegraphics[width=\linewidth,height=1.5in,keepaspectratio]{ca8.pdf}}
...
\end{itemize}
\centering
\only<1,5>{\includegraphics[width = 0.6\textwidth,height=1.55in,keepaspectratio]{sim_treat1.pdf}}%
\only<2-3>{\includegraphics[width = 0.6\textwidth,height=1.55in,keepaspectratio]{sim_treat2.pdf}}%
\only<4>{\includegraphics[width = 0.6\textwidth,height=1.55in,keepaspectratio]{sim_treat3.pdf}}%
}
}\else{
\frame{
\frametitle{Basic Idea}
...
\begin{center}
\only<1| handout:0>{\includegraphics[height=0.66\textheight,keepaspectratio]{toy_default.pdf}}%
\only<2| handout:0>{\includegraphics[height=0.66\textheight,keepaspectratio]{toy_1.pdf}}%
\only<3| handout:0>{\includegraphics[height=0.66\textheight,keepaspectratio]{toy_2.pdf}}%
\only<4| handout:0>{\includegraphics[height=0.66\textheight,keepaspectratio]{toy_3.pdf}}%
\only<5| handout:0>{\includegraphics[height=0.66\textheight,keepaspectratio]{toy_4.pdf}}%
\only<6| handout:0>{\includegraphics[height=0.66\textheight,keepaspectratio]{toy_5.pdf}}%
\only<7| handout:0>{\includegraphics[height=0.66\textheight,keepaspectratio]{toy_6.pdf}}%
\only<8| handout:0>{\includegraphics[height=0.66\textheight,keepaspectratio]{toy_7.pdf}}%
\only<9| handout:1>{\includegraphics[height=0.66\textheight,keepaspectratio]{toy_8.pdf}}%
\end{center}
\begin{itemize}
...
\begin{center}
\only<1| handout:0>{\includegraphics[height=0.62\textheight,keepaspectratio]{sim_dyn_1.pdf}}%
\only<2| handout:1>{\includegraphics[height=0.62\textheight,keepaspectratio]{sim_dyn_2.pdf}}%
\end{center}
\begin{itemize}
...
\vspace{-1em}
\only<4>{\includegraphics[width=\textwidth,height=1.75in,keepaspectratio]{sim_status1a.pdf}}%
\only<5>{\includegraphics[width=\textwidth,height=1.75in,keepaspectratio]{sim_status2a.pdf}}%
\only<6>{\includegraphics[width=\textwidth,height=1.75in,keepaspectratio]{sim_status3a.pdf}}%
\only<7>{\includegraphics[width=\textwidth,height=1.75in,keepaspectratio]{sim_status3b.pdf}}%
\only<8>{\includegraphics[width=\textwidth,height=1.75in,keepaspectratio]{sim_status4b.pdf}}%
\only<9>{\includegraphics[width=\textwidth,height=1.75in,keepaspectratio]{sim_status4b.pdf}}%
\only<10->{\includegraphics[width=\textwidth,height=1.75in,keepaspectratio]{sim_status5.pdf}}%
\end{column}
\end{columns}
\end{frame}
}
...
\only<3>{\centering\includegraphics[height=2.45in,keepaspectratio]{edr_status.pdf}}%
\only<4->{\centering\includegraphics[height=2.45in,keepaspectratio]{edr_status2.pdf}}%
\end{frame}
}\else{
\begin{frame}
 \frametitle{Election Day Registration (EDR) and Voter Turnout}
...
\it\red{Causal inference is a missing data problem.}
\end{center}\vspace{-1em}
\centering\includegraphics[height=2.45in,keepaspectratio]{edr_status2.pdf}%
\end{frame}
}\fi
...
\only<1>{
\centering%
Difference-in-Differences\\\vspace{0.2em}\includegraphics[height=2.25in,keepaspectratio]{edr_case_ct1.pdf}%
}%
\only<2>{
\centering%
\blue{IFEct} with Two Factors\\\vspace{0.2em}\includegraphics[height=2.25in,keepaspectratio]{edr_case_ct2.pdf}%
}%
% new Hampshire
\only<3>{
\centering%
Difference-in-Differences\\\vspace{0.2em}\includegraphics[height=2.25in,keepaspectratio]{edr_case_nh1.pdf}%
}%
\only<4>{
\centering%
\blue{IFEct} with Two Factors\\\vspace{0.2em}\includegraphics[height=2.25in,keepaspectratio]{edr_case_nh2.pdf}%
}%
...
\begin{center}
\only<1,3>{\includegraphics[width=\textwidth,height=2.45in,keepaspectratio]{edr_FL.pdf}}%
\only<2>{\includegraphics[width=.9\textwidth,height=2.45in,keepaspectratio]{edr_rawdata2.pdf}}%
\only<4>{\includegraphics[width=\textwidth,height=2.45in,keepaspectratio]{edr_FL2.pdf}}%
\end{center}
\end{frame}
}\else{
\begin{frame}[c]
...
\begin{center}
\visible<1->{\includegraphics[width=0.45\textwidth]{ex_Xu2017_fect_3.pdf}}%
\hspace{2em}
\visible<2->{\includegraphics[width=0.45\textwidth]{ex_Xu2017_ife_2.pdf}}%
\end{center}
\end{frame}
...
\begin{column}{0.5\textwidth}
  \vspace{-1em}
  \begin{center}
  \only<1,2>{\includegraphics[height=0.8\textheight]{edr_missing0.pdf}}%
  \only<3-4>{\includegraphics[height=0.8\textheight]{edr_missing2.pdf}}%
  \only<5->{\includegraphics[height=0.8\textheight]{state_capacity.png}}%
  \end{center}
\end{column}
\begin{column}{0.5\textwidth}
\begin{itemize}\itemsep1em 
